...
const Home = () => {
    ...
    return (
        <Container>
            ...
            <section>
                <Card style={{ backgroundColor: '#595D95', color: "white", paddingTop: '50px', paddingBottom: '50px', textAlign: 'center' }}>
                    <Card.Body>
